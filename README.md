...
Réaliser le site vitrine d'une franchise de restaurants. La franchise est fictive mais le type de nourriture (burger, pizza, asiatique,...) est laissé au choix.

Le site devait être **responsive** : au moins pour les petits écrans (xs) et les écrans moyens (md)
